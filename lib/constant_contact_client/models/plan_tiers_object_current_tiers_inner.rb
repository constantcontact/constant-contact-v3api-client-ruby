...
module ConstantContactClient
  ...
  class PlanTiersObjectCurrentTiersInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::PlanTiersObjectCurrentTiersInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::PlanTiersObjectCurrentTiersInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'usage_type')
        ...
        self.usage_type = 'CONTACTS'
      end

      if attributes.key?(:'current_usage')
        self.current_usage = attributes[:'current_usage']
      end
      ...
      if attributes.key?(:'tier_min')
        self.tier_min = attributes[:'tier_min']
      end

      if attributes.key?(:'tier_max')
        self.tier_max = attributes[:'tier_max']
      end
    ...
    def hash
      [usage_type, current_usage, tier, tier_min, tier_max, price, currency_code].hash
    end
