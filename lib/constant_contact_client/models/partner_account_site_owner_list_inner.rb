...
module ConstantContactClient
  class PartnerAccountSiteOwnerListInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::PartnerAccountSiteOwnerListInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::PartnerAccountSiteOwnerListInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'site_owner_name')
        self.site_owner_name = attributes[:'site_owner_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          site_owner_name == o.site_owner_name &&
    ...
    def hash
      [encoded_account_id, subscriber_count, organization_name, site_owner_name, billing_status, last_login_date].hash
    end
