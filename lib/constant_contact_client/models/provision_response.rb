  ...
  class ProvisionResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::ProvisionResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::ProvisionResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'provision_uuid')
        self.provision_uuid = attributes[:'provision_uuid']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          provision_uuid == o.provision_uuid
    end
    ...
    def hash
      [encoded_account_id, provision_uuid].hash
    end
