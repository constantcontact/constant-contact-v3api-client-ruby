...
module ConstantContactClient
  ...
  class GetContactTrackingReport200ResponseTrackingActivitiesInner
    # The contact ID.
    ...
    attr_accessor :campaign_activity_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::GetContactTrackingReport200ResponseTrackingActivitiesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::GetContactTrackingReport200ResponseTrackingActivitiesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'campaign_activity_name')
        self.campaign_activity_name = attributes[:'campaign_activity_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          campaign_activity_name == o.campaign_activity_name
    end
    ...
    def hash
      [contact_id, campaign_activity_id, created_time, tracking_activity_type, campaign_activity_name].hash
    end
