...
module ConstantContactClient
  ...
  class CreateTagRemoveActivityRequestSource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::CreateTagRemoveActivityRequestSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::CreateTagRemoveActivityRequestSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'new_subscriber')
        self.new_subscriber = attributes[:'new_subscriber']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@tag_ids.nil? && @tag_ids.length > 50
        invalid_properties.push('invalid value for "tag_ids", number of items must be less than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@tag_ids.nil? && @tag_ids.length > 50
      true
    end
    ...
    def tag_ids=(tag_ids)
      ...
      if tag_ids.length > 50
        fail ArgumentError, 'invalid value for "tag_ids", number of items must be less than or equal to 50.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          new_subscriber == o.new_subscriber
    end
    ...
    def hash
      [contact_ids, list_ids, tag_ids, all_active_contacts, new_subscriber].hash
    end
