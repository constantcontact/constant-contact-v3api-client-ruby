...
module ConstantContactClient
  class GetContactById200ResponseStreetAddressesInner
    # Unique ID for the street address
    attr_accessor :street_address_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::GetContactById200ResponseStreetAddressesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::GetContactById200ResponseStreetAddressesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'street_address_id')
        self.street_address_id = attributes[:'street_address_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          street_address_id == o.street_address_id &&
          kind == o.kind &&
          street == o.street &&
          city == o.city &&
          state == o.state &&
    ...
    def hash
      [street_address_id, kind, street, city, state, postal_code, country, created_at, updated_at].hash
    end
