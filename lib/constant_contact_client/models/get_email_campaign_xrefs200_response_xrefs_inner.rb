...
module ConstantContactClient
  class GetEmailCampaignXrefs200ResponseXrefsInner
    # Identifies an email campaign in the V2 API.
    attr_accessor :v2_email_campaign_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::GetEmailCampaignXrefs200ResponseXrefsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::GetEmailCampaignXrefs200ResponseXrefsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'v2_email_campaign_id')
        self.v2_email_campaign_id = attributes[:'v2_email_campaign_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          v2_email_campaign_id == o.v2_email_campaign_id &&
    ...
    def hash
      [v2_email_campaign_id, campaign_id, campaign_activity_id].hash
    end
