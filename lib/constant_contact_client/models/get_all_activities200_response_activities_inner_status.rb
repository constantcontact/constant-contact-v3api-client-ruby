...
module ConstantContactClient
  class GetAllActivities200ResponseActivitiesInnerStatus
    # The total number of items to be processed.
    attr_accessor :items_total_count
    ...
    attr_accessor :correctable_count
    ...
    attr_accessor :cannot_add_to_list_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConstantContactClient::GetAllActivities200ResponseActivitiesInnerStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConstantContactClient::GetAllActivities200ResponseActivitiesInnerStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'items_total_count')
        self.items_total_count = attributes[:'items_total_count']
      end

      if attributes.key?(:'items_completed_count')
        self.items_completed_count = attributes[:'items_completed_count']
      end
      ...
      if attributes.key?(:'correctable_count')
        self.correctable_count = attributes[:'correctable_count']
      end

      if attributes.key?(:'cannot_add_to_list_count')
        self.cannot_add_to_list_count = attributes[:'cannot_add_to_list_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          items_total_count == o.items_total_count &&
          items_completed_count == o.items_completed_count &&
          person_count == o.person_count &&
          error_count == o.error_count &&
          correctable_count == o.correctable_count &&
          cannot_add_to_list_count == o.cannot_add_to_list_count &&
    ...
    def hash
      [items_total_count, items_completed_count, person_count, error_count, correctable_count, cannot_add_to_list_count, list_count].hash
    end
